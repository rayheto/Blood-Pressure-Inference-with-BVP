...
out = HERE / "case_236_dynamic_fit.svg"
...
series = (
    ...
    ("high_pressure_weighted_bp_mmhg", "高压加权校正头", "#ba99ff", 2.7),
)
...
<title>流式血压动态校正效果：VitalDB 病例 236</title>
<desc>校准后30分钟的175个有效窗口，全部曲线使用60秒后向平均。普通校正头减少本例收缩压误差，但舒张压仍有明显误差。</desc>
...
<text x="55" y="50" font-size="27" font-weight="700">动态校正头：流式血压拟合对比</text>
...
<text x="830" y="91" font-size="17">普通校正 14.97 / 9.71</text>
