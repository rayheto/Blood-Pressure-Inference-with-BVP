...
The [rise-aware correction experiment](rise_head/README.md) trains a waveform-feature correction for larger changes from calibration and includes a four-curve animated comparison.
